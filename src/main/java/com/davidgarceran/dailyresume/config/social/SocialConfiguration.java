package com.davidgarceran.dailyresume.config.social;

import com.davidgarceran.dailyresume.repository.SocialUserConnectionRepository;
import com.davidgarceran.dailyresume.repository.CustomSocialUsersConnectionRepository;
import com.davidgarceran.dailyresume.security.social.CustomSignInAdapter;
...
public class SocialConfiguration implements SocialConfigurer {
    ...
    public void addConnectionFactories(ConnectionFactoryConfigurer connectionFactoryConfigurer, Environment environment) {
        ...
        String tumblrClientId = environment.getProperty("spring.social.tumblr.clientId");
        String tumblrClientSecret = environment.getProperty("spring.social.tumblr.clientSecret");
        if (tumblrClientId != null && tumblrClientSecret != null) {
            log.debug("Configuring TumblrConnectionFactory");
            connectionFactoryConfigurer.addConnectionFactory(
                    new TumblrConnectionFactory(
                            tumblrClientId,
                            tumblrClientSecret
                    )
            );
        } else {
            log.error("Cannot configure TumblrConnectionFactory id or secret null");
        }
    }
