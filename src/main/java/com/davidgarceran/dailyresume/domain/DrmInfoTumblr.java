 ...
 */
@Entity
@Table(name = "drm_tumblr_analytics")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class DrmInfoTumblr {
    ...
    //Most popular posts - w/reblogkey
    ...
    public DrmInfoTumblr(){}

    public DrmInfoTumblr(int day, int hours2, int hours4, int hours6, int hours8, int hours10, int hours12, int hours14, int hours16, int hours18, int hours20, int hours22, int hours24, long timestamp, Date date) {
        this.day = day;
        this.hours2 = hours2;
        this.hours4 = hours4;
        this.hours6 = hours6;
    ...
    public boolean equals(Object o) {
        ...
        DrmInfoTumblr that = (DrmInfoTumblr) o;
